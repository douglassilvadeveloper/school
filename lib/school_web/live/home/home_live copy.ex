defmodule SchoolWeb.Home.HomeLiveCopy do
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            Ajude a manter esse projeto aberto a todos. <.link navigate={~p"/maintenance"} class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Leia mais <span aria-hidden="true">&rarr;</span></.link>
          </div>
        </div>
